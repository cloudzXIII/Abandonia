        ...
        if match_rank then
          if not context.blueprint then
            ...
            if match_edi and not already[edi .. rank] then
              joker.ability.extra.played_while_stored[edi .. rank] = (joker.ability.extra.played_while_stored[edi .. rank] or 0) +
              1
              already[edi .. rank] = true
            end
            if match_enh and not already[enh .. rank] then
              joker.ability.extra.played_while_stored[enh .. rank] = (joker.ability.extra.played_while_stored[enh .. rank] or 0) +
              1
