            ...
            for i, v in ipairs(context.scoring_hand) do
                if guaranteed_lucky_cards[v] == nil and SMODS.has_enhancement(v, "m_lucky") then
                    for i = i + 1, #context.scoring_hand do
                        ...
                        if l ~= nil then
                            if v:get_id() == l:get_id() and SMODS.has_enhancement(l, "m_lucky") then
                                table.insert(guaranteed_lucky_cards, v)
                                if guaranteed_lucky_cards[l] == nil then table.insert(guaranteed_lucky_cards, l) end
                            end
                        end
                    end
                end
