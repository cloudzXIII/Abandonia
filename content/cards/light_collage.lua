...
SMODS.Joker {
    ...
    loc_vars = function(self, info_queue, card)
        local numerator,denominator=SMODS.get_probability_vars(card,1,card.ability.extra.foil_chance,"j_abn_light_collage_foil_chance")
        local numerator_2,denominator_2=SMODS.get_probability_vars(card,1,card.ability.extra.gloss_chance,"j_abn_light_collage_gloss_chance")
        return {
            vars={
                card.ability.extra.chips_gain,card.ability.extra.mult_gain,numerator,denominator,numerator_2,denominator_2,card.ability.extra.chips,card.ability.extra.mult
            },
        }
    end,
