...
SMODS.Joker {
  key = 'jenna_jester_girl',

  loc_vars = function(self, info_queue, card)
    local cae = card.ability.extra
    info_queue[#info_queue + 1] = G.P_CENTERS.j_abn_jinxie_clown_girl
  ...
  calculate = function(self, card, context)
    ...
    if next(SMODS.find_card("j_abn_jinxie_clown_girl")) and context.post_trigger and context.other_card.ability.set == "Joker" and not context.other_card.config.center.mod then
