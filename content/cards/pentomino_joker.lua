  ...
  calculate = function(self, card, context)
    ...
    if context.cardarea == G.jokers and context.before then
      ...
      if base_hand == "Straight" or base_hand == "Straight Flush" then
        ...
        -- Level up
        if all_light and card.ability.extra.triggered == 0 then
