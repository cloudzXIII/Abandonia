...
SMODS.Joker {
  ...
  calculate = function(self, card, context)
    if context.post_trigger and context.other_card.ability and context.other_card.ability.set and context.other_card.ability.set == "Joker" and context.other_card ~= card and not context.blueprint then
