  ...
  calculate = function(self, card, context)
    ...
    if context.before then
      ...
      for _, playing_card in ipairs(context.full_hand) do
        ...
        if has_gold and has_wild then break end
      end

      if has_gold and has_wild then
        for _, playing_card in ipairs(context.full_hand) do
          if SMODS.has_enhancement(playing_card, "m_wild") or SMODS.has_enhancement(playing_card, "m_gold") then
