...
ABN.CrimsonCard {
  key = "anarkia",
  pos = { x = 0, y = 1 },
  config = { extra = { enh_key = "abn_stk_reinforcement" } },
  use = function(self, card, area, copier)
    local c = G.jokers.cards[1]
    G.E_MANAGER:add_event(Event({
      trigger = 'after',
...
ABN.CrimsonCard {
  key = "zauri",
  pos = { x = 1, y = 3 },
  config = { extra = { enh_key = "abn_stk_first_aid" } },
  use = function(self, card, area, copier)
    local c = G.jokers.cards[1]
    G.E_MANAGER:add_event(Event({
      trigger = 'after',
...
ABN.CrimsonCard {
  key = "okertua",
  pos = { x = 7, y = 2 },
  config = { extra = { enh_key = "abn_stk_flux" } },
  use = function(self, card, area, copier)
    local c = G.jokers.cards[1]
    G.E_MANAGER:add_event(Event({
      trigger = 'after',
...
ABN.CrimsonCard {
  key = "amaigabea",
  pos = { x = 2, y = 3 },
  config = { extra = { enh_key = "abn_stk_zen" } },
  use = function(self, card, area, copier)
    local c = G.jokers.cards[1]
    G.E_MANAGER:add_event(Event({
      trigger = 'after',
...
ABN.CrimsonCard {
  key = "basua",
  pos = { x = 6, y = 2 },
  config = { extra = { enh_key = "abn_stk_plank" } },
  use = function(self, card, area, copier)
    local c = G.jokers.cards[#G.jokers.cards]
    G.E_MANAGER:add_event(Event({
      trigger = 'after',
