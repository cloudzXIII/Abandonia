return {
  descriptions = {
    ...
    Joker = {
      ...
      j_abn_cowboy_poker = {
        ...
        text = {
          ...
          "each held {C:attention}consumable{} gains a different {C:dark_edition}Edition",
          "Payout increases by {C:money}$#2#{} per different {C:dark_edition}Edition{} on Consumables",
      ...
      j_abn_alter_suits = {
        ...
        text = {
          ...
          {
            "If scoring hand contains no {C:inactive}Vanilla{} suits,",
            "this Joker gains {C:chips}+#3#{} Chips",
            "{C:inactive}(Currently{} {C:mult}+#2#{} {C:inactive}Mult{} {C:chips}+#1#{} {C:inactive}Chips){}",
          },
        }
      ...
      j_abn_metallic_upgrade = { -- to relocalise
        ...
        text = {
          "The {C:attention}First{} scoring {C:inactive}Vanilla{} {C:dark_edition}Enhancement{} card in a {C:attention}Spectrum{} hand",
      ...
      j_abn_super_eight = {
        name = "Super Eight",
        text = {
          "{C:attention}8's{} can't be {C:mult}debuffed{} and are considered every {C:inactive}Vanilla{} Suit",
      ...
      j_abn_consumable_tag = {
        name = "Consumable Tag",
        text = {
          "Whenever a {C:attention}Tag{} is obtained create a {C:inactive}Vanilla{} Consumable Tag",
    ...
    Spectral = {
      ...
      c_abn_body = {
        ...
        text = {
          "Creates a",
          "{C:abn_superrare,E:1}Super Rare{} Joker",
          "{C:inactive}(Must have room)",
        }
      },
      c_abn_mind = {
    ...
    Other = {
      ...
      p_abn_solid_state_kiddy = {
        name = 'Kiddy Solid State Pack',
        text = {
          'Choose {C:attention}#1#{} of up to',
          '{C:attention}#2#{} {C:solid_state}Solid State{} cards to',
          'be used immediately'
        }
      },
      p_abn_program_kiddy = {
        name = 'Kiddy Program Pack',
        text = {
          'Choose {C:attention}#1#{} of up to',
    ...
    Tarot = {
      ...
      c_abn_eon = {
        ...
        text = {
          ...
          "the {C:attention}rightmost{} Joker,",
          "Add a random {C:abn_perishable}Sticker",
          "to {C:attention}leftmost{} Joker",
        }
      },
      c_abn_snowflake = {
    ...
    artistry_cards = {
      c_abn_marquee = {
        ...
        text = {
          ...
          {
            "{C:common,s:0.8}Common{s:0.8}: {C:chips,s:0.8}+#1#{s:0.8}, {C:uncommon,s:0.8}Uncommon{s:0.8}: {C:chips,s:0.8}+#2#{}",
            "{C:rare,s:0.8}Rare{s:0.8}: {C:chips,s:0.8}+#3#{s:0.8}, {C:abn_superrare,s:0.8}Super Rare{s:0.8}: {C:chips,s:0.8}+#4#{}",
            "{C:legendary,s:0.8}Legendary{s:0.8}: {C:chips,s:0.8}+#5#{s:0.8}, {C:abn_parallelrare,s:0.8}Parallel Rare{s:0.8}: {C:chips,s:0.8}+#6#{}",
          }
        }
      },
      c_abn_pencil = {
        ...
        text = {
          ...
          {
            "{C:common,s:0.8}Common{s:0.8}: {C:mult,s:0.8}+#1#{s:0.8}, {C:uncommon,s:0.8}Uncommon{s:0.8}: {C:mult,s:0.8}+#2#{}",
            "{C:rare,s:0.8}Rare{s:0.8}: {C:mult,s:0.8}+#3#{s:0.8}, {C:abn_superrare,s:0.8}Super Rare{s:0.8}: {C:mult,s:0.8}+#4#{}",
            "{C:legendary,s:0.8}Legendary{s:0.8}: {C:mult,s:0.8}+#5#{s:0.8}, {C:abn_parallelrare,s:0.8}Parallel Rare{s:0.8}: {C:mult,s:0.8}+#6#{}",
          }
        }
      },
      c_abn_eraser = {
        ...
        text = {
          {
            ...
            "{C:mult}Destroy{} the Joker",
            "{C:attention}All Rankless{} cards gain {C:chips}Chips{} and",
        ...
        text = {
          {
            "Select a card and a Joker",
            "{C:mult}Destroy{} the Joker",
            "{C:attention}All{} cards with the same {C:attention}suit{} as",
  ...
  misc = {
    ...
    dictionary = {
      ...
      k_spectral_kiddy = "Kiddy Spectral Pack",
      k_celestial_kiddy = "Kiddy Celestial Pack",
      k_astro_kiddy = "Kiddy Astro Pack",
      k_sigil_kiddy = "Kiddy Sigil Pack",
      k_weather_kiddy = "Kiddy Forecast Pack",
      k_lexica_kiddy = "Kiddy Lexica Pack",
      k_continent_kiddy = "Kiddy Continent Pack",
      k_solid_state_kiddy = "Kiddy Solid State Pack",
      k_program_kiddy = "Kiddy Program Pack",
      k_calligraphy_kiddy = "Kiddy Calligraphy Pack",
