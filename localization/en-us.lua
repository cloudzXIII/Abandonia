return {
  descriptions = {
    ...
    Other = {
      --[[
       Ok so I was originally gonna have EnHaNcEmEnTs Seals, Stickers, Stamps and Enhancement Stickers in seperate files
       but for some reason the localisation doesn't load there??? It only works in the main loc
       which I find kinda weird, so :p
       ]]
