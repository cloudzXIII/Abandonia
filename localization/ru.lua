return {
  descriptions = {
    ...
    Back = {
      ...
      b_abn_photometry = {
        ...
        text = {
          ...
          "Без {C:inactive}ванильных{} мастей",
        }
      },
      b_abn_synesthic = {
    ...
    Joker = {
      ...
      j_abn_bloke_joker = {
        ...
        text = {
          {
            "Каждая {C:enhanced}#1#{} и",
            "{C:enhanced}#2#{} перезапускаются",
      ...
      j_abn_snoozing_joker = {
        ...
        text = {
          ...
          "Джокеры с {C:inactive}ванильным{} {C:dark_edition}выпуском{} дают {C:gold}+#2#{} Вознесилы",
          "Карты с {C:inactive}ванильным{} {C:dark_edition}выпуском{} дают {C:gold}+#3#{} Вознесилы при подсчете",
          "Если карта с {C:inactive}ванильной{} мастью и {C:dark_edition}выпуском{} совпадает с {C:dark_edition}выпуском{}",
      ...
      j_abn_joker_ena = {
        ...
        text = {
          "Сыгранные карты с {C:dark_edition}модовыми{}",
          "{C:diamond}Светлыми{} мастями дают {C:mult}+#1#{} множ.",
          "при подсчете"
        }
      },
	    j_abn_amplifier = {
        ...
        text = {
          ...
          },
          {
            ...
            "масть, если не было сыграно {C:inactive}ванильных{} мастей",
        ...
        name = "Fortlatro",
        text = {
          "{C:inactive}Ванильные{} расходники и Джокеры больше {C:attention}не{} появляются",
          "Когда {C:chips}Малый Блайнд{} выбран, создает случайный {C:dark_edition}модовый{} расходник",
          "Когда {C:attention}Большой Блайнд{} выбран, создает случайного {C:dark_edition}модового{} Джокера",
          "Получает {X:chips,C:white}X#2#{} фишек, за каждый {C:attention}уникальный {C:dark_edition}модовый{C:attention} расходник{}, использованное за партию",
          "Получает {X:mult,C:white}X#4#{} фишек, за каждого {C:attention}уникального {C:dark_edition}модового{C:attention} Джокера{}, полученного за партию",
        ...
        name = "Дирак",
        text = {
          "{C:dark_edition}Негативные{} {C:dark_edition}модовые{} карты и Джокеры не могут быть {C:mult}ослаблены{}",
          "Если этот Джокер {C:dark_edition}Негативный{}, увеличивает {C:attention}размер руки{} на {C:attention}+#5#{}",
          "Получает {X:chips,C:white}X#2#{} фишек за каждую {C:dark_edition}модовую Негативную{} карту в подсчете",
          "Получает {X:mult,C:white}X#4#{} множ. за каждого {C:dark_edition}модового Негативного{} Джокера",
        ...
        text = {
          "{C:attention}8-ки{} не могут быть {C:mult}ослаблены{} и считаются каждой {C:inactive}ванильной{} мастью",
      ...
      j_abn_rorrim = {
        ...
        text = {
          ...
          {
            "Карты с таким же {C:attention}достоинстом{},",
      ...
      j_abn_foreign_advert = {
        ...
        text = {
          ...
          "When upgrading a {C:dark_edition}Modded{} hand create a random {C:dark_edition}negative{} {C:attention}modded{} consumable",
    ...
    abn_credit_card = {
      ...
      credit_abn_imaginaryneon = {
        ...
        text = {
          "Добавил некоторых",
          "{C:attention}Джокеров{}",
          "Попробуйте {C:attention}Manlatro{}!",
        }
      },
      credit_abn_noodle = {
        name = "",
    ...
    Other = {
      ...
      p_abn_standard_kiddy = {
        name = "Детский стандартный набор",
        text = {
          "Выберите {C:attention}#1#{} из",
          "{C:attention}#2#{C:attention} Игральных{} карт, чтобы",
          "добавить в вашу колоду",
        }
      },
      p_abn_arcana_kiddy = {
        name = "Детский набор аркана",
        text = {
          "Выберите {C:attention}#1#{} из",
          "{C:attention}#2#{} карт {C:tarot}Таро{},",
          "чтобы использовать сразу",
        }
      },
      p_abn_spectral_kiddy = {
        name = "Детский спектральный набор",
        text = {
          "Выберите {C:attention}#1#{} из",
      ...
      p_abn_celestial_kiddy = {
        name = "Детский небесный набор",
        text = {
          "Выберите {C:attention}#1#{} из",
          "{C:attention}#2#{} карт {C:planet}Планет{},",
          "чтобы использовать сразу",
        }
      },
      p_abn_astro_kiddy = {
        name = 'Детский астронабор',
        text = {
          "Выберите {C:attention}#1#{} из",
      ...
      p_abn_weather_kiddy = {
        name = 'Детский набор прогнозов',
        text = {
          "Выберите {C:attention}#1#{} из",
          "{C:attention}#2#{} {C:weather_report}Прогнозов погоды{}",
        }
      },
      p_abn_lexica_kiddy = {
        name = 'Детский набор лексики',
        text = {
          "Выберите {C:attention}#1#{} из",
          "{C:attention}#2#{} карт {C:lexica}Лексики{}"
        }
      },
      p_abn_continent_kiddy = {
        name = 'Детский набор континентов',
        text = {
          "Выберите {C:attention}#1#{} из",
          "{C:attention}#2#{} карт {C:continent}Континентов{}"
        }
      },
      p_abn_solid_state_kiddy = {
        name = 'Детский твердотельный набор',
        text = {
          "Выберите {C:attention}#1#{} из",
      ...
      p_abn_program_kiddy = {
        name = 'Детский программный набор',
        text = {
          "Выберите {C:attention}#1#{} из",
      ...
      p_abn_calligraphy_kiddy = {
        name = "Детский каллигрфический набор",
        text = {
          "Выберите {C:attention}#1#{} из",
      ...
      p_abn_calamity_kiddy = {
        name = 'Детский набор бедствий',
        text = {
          "Выберите {C:attention}#1#{} из",
          "{C:attention}#2#{} карт {C:abn_calamity}Бедствий{},",
          "чтобы использовать сразу",
        }
      },
      ...
      p_abn_crimson_kiddy = {
        name = "Детский багряный набор",
        text = {
          "Выберите {C:attention}#1#{} из",
          "{C:attention}#2#{} {C:crimson}Багряных{} карт,",
          "чтобы использовать сразу",
        },
      },
      --#endregion
  ...
  misc = {
    ...
    dictionary = {      
      k_abn_lead_dev = "Ведущий разработчик",
      k_abn_coder = "Кодер",
      k_abn_artist = "Художник",
      k_abn_founder = "Основатель",
      k_abn_music = "Музыкант",
      k_abn_hybrid_art_code = "Художник/Кодер",
      k_abn_github = "Github",
      k_abn_kofi = "Ko-fi",
      ...
      abn_crimsonbooster = "Багряный набор",
      abn_calligraphybooster = "Каллиграфический набор",
      abn_illusionbooster = "Набор иллюзий",
      ...
      k_arcana_kiddy = "Детский набор аркана",
      k_spectral_kiddy = "Детский спектральный набор",
      k_celestial_kiddy = "Детский небесный набор",
      k_astro_kiddy = "Детский астронабор",
      k_sigil_kiddy = "Детский набор символов",
      k_weather_kiddy = "Детский набор прогнозов",
      k_lexica_kiddy = "Детский набор лексики",
      k_continent_kiddy = "Детский набор континентов",
      k_solid_state_kiddy = "Детский твердотельный набор",
      k_program_kiddy = "Детский программный набор",
      k_calligraphy_kiddy = "Детский каллигрфический набор",
      ...
      b_algebraic_cards = "Алгебраические карты",
      k_algebraic = "Алгебраическая",

      b_illusion_cards = "Иллюзионные карты",
      k_illusion = "Иллюзия",
	  
	    b_ram_cards = "RAM карты",
      k_ram = "RAM",
    },
    labels = {
      -- Stamps
