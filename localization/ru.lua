  ...
  descriptions = {
    ...
    Joker = {
      ...
      j_abn_archibald = {
        ...
        text = {
          "Получает {X:chips,C:white}X#2#{} фишек,",
          "когда подсчитывается рука",
          "только с {C:attention}четными{} картами",
          "{C:inactive}(сейчас {C:white,X:chips}X#1#{C:inactive} фишек){}",
      ...
      j_abn_agent_jimbo = {
        ...
        text = {
          {
            "Все {C:attention}расходники{} стоят в {C:attention}2{}",
            "раза больше, но получают {C:attention}случайный{}",
      ...
      j_abn_balatro_the_movie = {
        ...
        text = {
          ...
          },
          {
            ...
            "по одной карте каждой {C:attention}ванильной{} масти,",
        ...
        text = {
          {
            ...
            "{C:attention}2 ванильные{} и {C:attention}модовые{} масти,",
      ...
      j_abn_joker_ena = {
        ...
        name = "Сотовая вышка",
        text = {
          "{C:attention}Модовые{} {C:dark_edition}улучшения{} на {C:attention}ванильных{}",
          "мастях дают на {C:attention}50%{} больше {C:chips}фишек{}",
		      "и {C:mult}множ.{} ({C:attention}100%{} на {C:attention}модовых{} мастях)"
        }
      },
	    j_abn_shy_gall = {
        name = "Стесняшка",
