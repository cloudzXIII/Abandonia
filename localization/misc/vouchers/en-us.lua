    ...
    Voucher = {
      ...
      v_abn_pattern = {
        ...
        text = {
          ...
          "creates your all time {C:attention}most{}",
          "{C:attention}used{} {C:tarot}Tarot{} or {C:planet}Planet{} card",
      ...
      v_abn_tesselation = {
        ...
        text = {
          "When {C:attention}Blind{} is selected,",
          "creates {C:attention}2{} of your all time",
          "{C:attention}most used{} Consumables",
          "{C:inactive}(Must have room)",
        }
      },
      v_abn_silver_spoon = {
