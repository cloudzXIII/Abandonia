        ...
        Enhanced = {
            ...
            m_abn_teatag = {
                ...
                text = {
                    ...
                    "{C:attention}Карту с чайным пакетиком{} в",
            ...
            m_abn_teastain = {
                ...
                text = {
                    ...
                    "{C:attention}Карту с чайным следом{} в",
                    "вашей {C:attention}полной колоде{}",
                }
            },
            m_abn_polkadot = {
            ...
            m_abn_monitor = {
                ...
                text = {
                    "Дает {X:mult,C:white}^множ.{}, равный числу",
                    "подсчитываемых карт масти {V:1}#1#{}",
            ...
            m_abn_sew = {
                ...
                text = {
                    ...
                    "за каждую сыгранную {C:attention}Сшитую{} карту",
            ...
            m_abn_darkner = {
                ...
                text = {
                    ...
                    "сыгранную и находящуюся",
                    "в руке {C:spades}Темную масть{}",
            ...
            m_abn_lightner = {
                ...
                text = {
                    "{C:chips}+#1#{} фишек и {C:mult}+#2#{} множ. за каждую",
                    "сыгранную и находящуюся",
                    "в руке {C:diamonds}Светлую масть{}",
                    "{C:mult}Самоуничтожается{}, если сыграна с {C:attention}#3#{}",
            ...
            m_abn_first_aid = {
                name = "Аптечная карта",
                text = {
                    "Получает {C:mult}+#4#{} множ., если",
                    "разыграна с {C:mult}ослабленной{} картой,",
                    "Получает {C:chips}+#3#{} фишек, когда",
                    "карта {C:mult}уничтожается{}",
            ...
            m_abn_discontinued = {
                ...
                text = {
                    ...
                    "за каждый уникальный {C:attention}Тег{},",
                    "полученный в этой партии",
                    "{C:inactive}(сейчас {C:gold}+#1#{C:inactive},{} {C:chips}+#2#{C:inactive})",
                }
            },
            m_abn_tile = {
                name = "Плиточная карта",
                text = {
                    "Возвращается в {C:attention}колоду{},",
                    "когда {C:attention}сыграна{}"
                }
            },
            m_abn_papermache = {
                name = "Папье-маше карта",
                text = {
                    "{X:chips,C:white}X#1#{} фишек, если не подсчитана",
                    "на {C:attention}нечетной{} карте",
                    "{X:mult,C:white}X#2#{} множ., если не подсчитана",
                    "на {C:attention}четной{} карте",
                }
            },
            m_abn_honey = {
                name = "Медовая карта",
                ...
                text = {
                    "Дает {C:chips}+#1#{} фишек за каждое {C:attention}уникальное{}",
                    "{C:dark_edition}улучшение{} и {C:mult}+#2#{} множ. за каждый",
                    "{C:attention}уникальный{} {C:dark_edition}выпуск{} в подсчете",
                    "Если эта карта {C:mult}уничтожена{}, все карты",
                    "в подсчете получают {C:chips}+#3#{} фишек"
                }
            },
                m_abn_bramble = {
            ...
            m_abn_flypaper = {
                name = "Липучая карта",
                text = {
                    "{C:attention}Ловит{} {C:purple}насекомое{}, если есть в",
                    "{C:attention}победной руке{}, независимо от того,",
                    "в {C:attention}подсчете{} она или в {C:attention}руке",
                    "Ловит разных {C:purple}насекомых в",
                    "зависимости от {C:attention}обстоятельств"
                }
            },
        },
        Other = {
            ...
            abn_stk_wild = {
                ...
                text = {
                    ...
                    "считается {C:attention}каждой мастью{}",
                    "одновременно"
                }
            },
            abn_stk_gold = {
            ...
            abn_stk_petroleum = {
                ...
                text = {
                    ...
                    "Превращается в {C:enhanced}Подожженную{}",
                    "наклейку, если очки {C:red,E:2}в огне"
                }
            },
            abn_stk_oilfire = {
                name = "Подожженный",
            ...
            abn_stk_hazard = {
                ...
                text = {
                    ...
                    "другого {C:attention}Джокера{} с такой же {C:enhanced}наклейкой{}",
            ...
            abn_stk_monitor = {
                name = "Мониторный",
                text = {
                    "{X:mult,C:white}^множ.{}, равный числу",
                    "подсчитываемых {C:dark_edition}<Мастей>",
                }
            },
