        ...
        Joker = {
            ...
            j_abn_avatar_of_luck = {
                ...
                text = {
                    ...
                    {
                        "Если сыгранная рука содержит {C:attention}Счастливую{}",
                        "карту, она получает {C:gold}+#3#{} Вознесилы за каждую",
                        "подсчитанную {C:attention}Счастливую{} карту в этом раунде"
                    },
                    {
                        "После игры {C:attention}#2#{} {C:inactive}[#1#]{} рук, содержащих",
                        "{C:attention}#2# Счастливых{} карт, уничтожить этого Джокера",
                        "и {C:attention}удвоить{} уровень всех {C:attention}рук{}"
                    }
                }
            },
            j_abn_aviator = {
            ...
            j_abn_double_dip = {
                ...
                text = {
                    "Дает {C:attention}базовые {C:chips}фишки{} и",
                    "{C:red}множ.{} сыгранной {C:attention}покерной руки",
                }
            },
            ...
            j_abn_meatkin = {
                name = 'Meatkin Joker',
                text = {
                    "Когда {C:attention}Cтальная{} карта подсчитывается,",
                    "каждая не-{C:attention}Cтальная{} карта в подсчете",
            ...
            j_abn_owen = {
                ...
                text = {
                    ...
                    {
                        "{C:abn_arrow}Стрелы{} навсегда получают",
                        "{C:mult}множ.{} при подсчете, равный полной",
                        "{C:attention}цене продажи{} всех Джокеров",
                        "{C:inactive}(Получит {C:mult}+#3#{C:inactive} множ.)"
                    }
                }
            },
            --#endregion
            ...
            j_abn_spihcneve = {
                ...
                text = {
                    {
                        "Когда карта {C:attention}С множителем{} подсчитывается,",
                        "карты не-{C:attention}С множителем{} в подсчете",
                        "навсегда получают {C:chips}+#1#{} фишек",
                    },
                    {
                        "Когда {C:attention}четные{} карты {C:attention}С множителем{}",
                        "подсчитываются, {C:attention}нечетные{} карты не-{C:attention}C множителем",
            ...
            j_abn_the_gleam = {
                ...
                text = {
                    {
                        "{C:white,X:mult}X#1#{} множ, если сыгранная",
                        "рука содержит {C:attention}5{} или более",
                        "подсчитываемых {C:diamonds}Светлых мастей{}"
                    },
                    {
                        "Если сыгранная рука содержит",
                        "только {C:dark_edition}Светлые{} карты, повышает {C:planet}планетный{}",
                        "уровень {C:attention}рангов{} всех карт в подсчете",
                    }
                }
            },
            j_abn_the_gloom = {
                ...
                text = {
                    ...
                    {
                        "Если сыгранная рука содержит",
                        "только {C:dark_edition}Темные{} карты, повышает {C:planet}планетный{}",
                        "уровень {C:attention}рангов{} всех карт в подсчете",
                    }
                }
            },
