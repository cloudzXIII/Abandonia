        ...
        Joker = {
            ...
            j_abn_exciton_event = {
                ...
                text = {
                    ...
                    "{C:attention}повышает уровень{} случайной руки на {C:attention}2",
                    "Шанс {C:green}1 к 6{} уничтожить {C:red}75%{} вашей колоды"
                }
            },
            --#endregion
            ...
            j_abn_failed_test = {
                ...
                text = {
                    "Сыгранные {C:attention}#1#{} дают",
                    "свои +фишки как Xмнож.",
                    "{C:attention}(рука меняется каждую руку)"
                }
            },
            ...
            j_abn_rereleased_special_collector_edition = {
                ...
                text = {
                    "Если подсчитываемая рука состоит только из карт с {C:dark_edition}выпуском{},",
                    "и имеет четное число {C:inactive}ванильных выпусков{} и нечетное",
                    "число {C:dark_edition}модовых выпусков{} или наоборот,",
                    "этот Джокер получает {C:gold}+#2#{} Вознесилы,",
                    "умноженное на число четных {C:dark_edition}выпусков{}",
                    "{C:inactive}(сейчас {C:gold}+#1# {C:inactive}Вознес.)"
                }
            },
            j_abn_respectable = {
