...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    // pale.g se usa como seed igual que los otros shaders de Balatro
    float t = pale.g + time * 0.0001;
    if (tex.a == 0){
        tex.a = 0;
    } else {
        ...
        brightened = 1.0 - (1.0 - brightened) * (1.0 - brightened);
        tex.rgb = clamp(brightened, 0.0, 1.0);
    }
